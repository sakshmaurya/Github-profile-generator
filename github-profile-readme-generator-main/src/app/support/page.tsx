      ...
      <main className="container mx-auto flex-1 px-4 py-12">
        <div className="page-content mx-auto max-w-4xl">
          ...
          <div className="my-6 flex flex-wrap gap-3">
            <a
              href="https://www.paypal.me/YOUR_PAYPAL"
              target="_blank"
            ...
            <a
              href="https://www.buymeacoffee.com/YOUR_BUYMEACOFFEE"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
          ...
          <a
            href="https://twitter.com/intent/tweet?text=Wow:&url=https%3A%2F%2Fyour-domain.com%2Fgithub-profile-readme-generator"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src="https://img.shields.io/twitter/url?style=social&url=https%3A%2F%2Fyour-domain.com%2Fgithub-profile-readme-generator"
