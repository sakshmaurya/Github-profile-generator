    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="container mx-auto flex-1 px-4 py-12">
        <div className="page-content mx-auto max-w-4xl">
          ...
          <a href="https://github.com/YOUR_USERNAME" target="_blank" rel="noopener noreferrer">
            <img
              src="https://github-readme-stats.vercel.app/api/top-langs/?username=YOUR_USERNAME&layout=compact&hide=html"
              width="320"
              alt="YOUR_USERNAME's github top skills"
            />
          </a>
          ...
          <img
            src="https://komarev.com/ghpvc/?username=YOUR_USERNAME&style=flat-square"
            alt="YOUR_USERNAME"
            className="my-4"
          />
  ...
  update-readme-with-blog:
    ...
    steps:
      ...
      - uses: gautamkrishnar/blog-post-workflow@master
        with:
          feed_list: 'https://dev.to/feed/YOUR_USERNAME, https://medium.com/feed/@YOUR_USERNAME'`}</code>
          </pre>
