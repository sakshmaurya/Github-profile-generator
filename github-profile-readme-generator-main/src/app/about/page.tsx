      ...
      <main className="container mx-auto flex-1 px-4 py-12">
        <div className="page-content mx-auto max-w-4xl">
          ...
          <div className="mb-8 flex gap-2">
            <a
              href="https://github.com/YOUR_USERNAME/YOUR_REPO/blob/master/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Image
                src="https://img.shields.io/github/license/YOUR_USERNAME/YOUR_REPO?style=flat-square"
          ...
          <div className="my-6 flex gap-3">
            ...
            >
              <Image
                src="https://img.shields.io/github/issues/YOUR_USERNAME/YOUR_REPO?style=flat-square"
            ...
            <a
              href="https://github.com/YOUR_USERNAME/YOUR_REPO/pulls"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Image
                src="https://img.shields.io/github/issues-pr/YOUR_USERNAME/YOUR_REPO?style=flat-square"
          ...
          <a
            href="https://github.com/YOUR_USERNAME/YOUR_REPO/graphs/contributors"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Image
              src="https://contributors-img.web.app/image?repo=YOUR_USERNAME/YOUR_REPO"
              alt="Contributors"
              className="my-4"
              width={600}
              height={600}
          ...
          <p>
            ...
            username. For example, my GitHub username is <strong>YOUR_USERNAME</strong> so I created a
            new repository with the name <strong>YOUR_USERNAME</strong>. Note: at the time of this
          ...
          <Image
            src="https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/master/src/images/github-profile-readme-generator.gif"
