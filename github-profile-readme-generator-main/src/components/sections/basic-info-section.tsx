...
import { SectionOrderSelector } from '@/components/ui/section-order-selector';
...
export function BasicInfoSection({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Profile Manager */}
      {currentData && onLoadProfile && (
        <ProfileManager currentData={currentData} onLoadProfile={onLoadProfile} />
      )}

      {/* Section Order Selector */}
      {sectionOrder && onSectionOrderChange && (
        <SectionOrderSelector sectionOrder={sectionOrder} onSectionOrderChange={onSectionOrderChange} />
      )}

      {/* Color Theme Selector */}
      {colorTheme && onColorThemeChange && (
        <ColorThemeSelector selectedTheme={colorTheme} onThemeChange={onColorThemeChange} />
      )}

      {/* QR Code Generator */}
      <CollapsibleSection title="QR Code Generator" defaultOpen={false}>
        <QRCodeGenerator githubUsername={githubUsername} />
      </CollapsibleSection>
